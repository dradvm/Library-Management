  ...
  <div class="mx-20 my-8 w-100">
    ...
    <div class="mt-3">
      ...
      >
        ...
        <div class="flex justify-center" style="width: 20%">Trạng thái</div>
        <div class="flex justify-center" style="width: 20%"></div>
      ...
      <div class="rounded" v-if="!isLoading">
        ...
        >
          ...
          <div class="flex justify-center font-medium" style="width: 20%">
            <div
...
const trangThais = ref(["Confirmed", "Book Returned", "Out Dated"]);
